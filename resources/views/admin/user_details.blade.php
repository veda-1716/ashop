                                ...
                                @foreach ($likes as $like)
                                    <tr>
                                        ...
                                        <td><a class="nav-link" title="show this product"
                                                href="{{ route('single_product', $like->product_id) }}">{{ $like->product_id }}</a>
                                        </td>
                                    </tr>
                                @endforeach
                            ...
                            <tbody>
                                ...
                                @foreach ($likes as $like)
                                    <tr>
                                        <td> <span class="bg-info p-1 rounded">Liked</span> Product id</td>
                                        <td><a class="nav-link" title="show this product"
                                                href="{{ route('show_single_product', $like->product_id) }}">{{ $like->product_id }}</a>
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                @foreach ($cartProducts as $product)
                                    <tr>
                                        <td> <span class="bg-warning p-1 rounded">Cart</span> Product id</td>
                                        <td><a class="nav-link" title="show this product"
                                                href="{{ route('show_single_product', $product->product_id) }}">{{ $product->product_id }}</a>
                                        </td>
                                    </tr>
                                @endforeach
