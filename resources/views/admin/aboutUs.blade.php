        ...
        <main class="bg-light">
            <div class="container-fluid px-4 ">
                ...
                <form class=" p-2 shadow bg-light rounded my-4 " method="post" action="{{ route('admin.aboutUs') }}">
                    @csrf
                    <h2 class="text-success shadow p-3 bg-success text-light border border-success text-capatilized">
                        {{ __('Add about us page Details') }}</h2>
                    <div class="row mb-3">
                    ...
                    <div class="mt-4 mb-0">
                        <div class="d-grid"><button class="btn btn-success btn-block btn-lg">Submit</button></div>
                    </div>
                </form>
            </div>
        </main>
