                                        ...
                                        <tbody>
                                            @forelse ($products as $product)
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td class="">
                                                        ${{ $product->product->price ? $product->product->price : '00' }}.00
                                                    </td>
                                                    <td class="">
                                                        <button type="button" class="btn product-remove"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="subtotal">
                                                    ...
                                                    <div class="price" wire:model="total">
                                                        ${{ $total ? $total : '00' }}.00
                                                    </div>
                                                </div>
                                                <div class="subtotal">
                                ...
                                <div class="cart-total">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="subtotal">
                                                <div class="title">Subtotal</div>
                                                <div class="price" wire:model="total">${{ $total ? $total : '00' }}.00
>>>>>>> 40da7fbf7d9900adbaea14c4772e8a7393be94d9
                                                </div>
                                            </div>
                                            <div class="subtotal">
