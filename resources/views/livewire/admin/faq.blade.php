                ...
                <div class="row mb-3">
                    <div class="col-12 mx-auto">
                        <div class="form-floating mb-3 mb-md-0">
                            <input class="form-control @error('question') is-invalid @enderror"
                                wire:model.lazy="question" id="question" type="text" placeholder="Enter Question" />
                    ...
                    <div class="col-12 mx-auto my-3">
                        <div class="form-floating">
                            <textarea class="form-control @error('answer') is-invalid @enderror " wire:model.lazy="answer" name="answer"
                                placeholder="Answer" id="answer" cols="30" rows="10"></textarea>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <button class="btn btn-sm btn-danger" title="delete this row"
                                                ...
                                                wire:click="delete({{ $faq->id }})">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            @empty
